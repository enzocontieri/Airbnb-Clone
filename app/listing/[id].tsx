...
const DetailsPage  = () => {
    ...
    //chama as opções de compartilhar do sistema nativo 
    ...
    // efeito para redimensionar imagem conforme o scrollview movimenta 
    ...
    // Ao descer a imagem completa cria um header 
    ...
    <View style={styles.container}>
      <Animated.ScrollView   
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.rooms}>
            {listing.guests_included} hóspedes · {listing.bedrooms} quartos · {listing.beds} camas ·{' '}
      ...
      <Animated.View style={defaultStyles.footer} entering={SlideInDown.delay(200)}>
        ...
        <TouchableOpacity style={styles.footerText}>
            <Text style={styles.footerPrice}>R${Math.round(listing.price * 5.30)}</Text>
            <Text>noite</Text>
          </TouchableOpacity>
